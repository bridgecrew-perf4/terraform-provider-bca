...
func resourceOriginCACertificate() *schema.Resource {
	return &schema.Resource{
		Create: resourceOriginCACertificateCreate,
		Read:   resourceOriginCACertificateRead,
		Delete: resourceOriginCACertificateDelete,
...
func resourceOriginCACertificateCreate(d *schema.ResourceData, meta interface{}) error {
...
func resourceOriginCACertificateRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*cloudflare.API)
	certID := d.Id()
...
func resourceOriginCACertificateDelete(d *schema.ResourceData, meta interface{}) error {
	log.Printf("[INFO] This resource cannot be deleted.")
